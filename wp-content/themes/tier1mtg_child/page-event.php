			...
			<div class="event_anden_sektion_container">
				...
				<div class="event_indhold">
					...
					<div class="event_anden_text_felt">
						...
						<h3 class="h3_acc">Info: Glæd dig til vores kommende event hos Tier1MTG. Kom til hygge i trygge rammer, hvor du kan spille med andre og vinde fede præmier.<br><br>Tilmelding starter den 1. juli.
						</h3>
					</div>
				</div>
				...
				<div class="event_indhold">
					...
					<button class="event_mere_knap knapper_dark">LÆS MERE</button>
					<div class="event_anden_text_felt">
						<h2 class="h2_acc">Lotus Game</h2>
						<h3 class="h3_acc">Dato: 10-08-2021</h3>
						<h3 class="h3_acc">Format: Old School</h3>
						<h3 class="h3_acc">Info: Glæd dig til vores kommende event hos Tier1MTG. Kom til hygge i trygge rammer, hvor du kan spille med andre og vinde fede præmier.<br><br>Tilmelding starter den 25. juli.
						</h3>
					</div>
				</div>
				<div class="event_indhold">
					...
					<button class="event_mere_knap knapper_dark">LÆS MERE</button>
					<div class="event_anden_text_felt">
						<h2 class="h2_acc">Flip the Coin Rave</h2>
						<h3 class="h3_acc">Dato: 20-08-2021</h3>
						<h3 class="h3_acc">Format: Standard</h3>
						<h3 class="h3_acc">Info: Glæd dig til vores kommende event hos Tier1MTG. Kom til hygge i trygge rammer, hvor du kan spille med andre og vinde fede præmier.<br><br>Tilmelding starter den 5. august.
						</h3>
					</div>
				</div>
				<div class="event_indhold">
					...
					<button class="event_mere_knap knapper_dark">LÆS MERE</button>
					<div class="event_anden_text_felt">
						<h2 class="h2_acc">Old Boys Tier1</h2>
						<h3 class="h3_acc">Dato: 01-09-2021</h3>
						<h3 class="h3_acc">Format: Old School</h3>
						<h3 class="h3_acc">Info: Glæd dig til vores kommende event hos Tier1MTG. Kom til hygge i trygge rammer, hvor du kan spille med andre og vinde fede præmier.<br><br>Tilmelding starter den 15. august.
						</h3>
					</div>
				</div>
			</div>
