	...
	<main id="main" <?php generate_do_element_classes( 'main' ); ?>>
		...
		<section id="event_anden_sektion">
			<div class="top">
				...
				<div class="event_video_some">
					<iframe width="560" height="315" src="http://kasperdyhl.dk/tier1mtg/wp-content/uploads/2021/06/Video-v3.mp4">
					</iframe>
				</div>
			</div>
			<div class="event_anden_sektion_container">
				<div class="event_indhold">
					...
					<div class="event_anden_text_felt">
						...
						<p class="p_event">Info: Glæd dig til vores kommende event hos Tier1MTG. Kom til hygge i trygge rammer, hvor du kan spille med andre og vinde fede præmier.
							<br>
				...
				<div class="event_indhold">
					...
					<div class="event_anden_text_felt">
						...
						<p class="p_event">Info: Glæd dig til vores kommende event hos Tier1MTG. Kom til hygge i trygge rammer, hvor du kan spille med andre og vinde fede præmier.
							<br>
							<br>Tilmelding starter den 1. juli.
						</p>
					</div>
				</div>
				...
				<div class="event_indhold">
					...
					<div class="event_anden_text_felt">
						...
						<p class="p_event">Info: Glæd dig til vores kommende event hos Tier1MTG. Kom til hygge i trygge rammer, hvor du kan spille med andre og vinde fede præmier.
							<br>
							<br>Tilmelding starter den 25. juli.
						</p>
					</div>
				</div>
				<div class="event_indhold">
					...
					<div class="event_anden_text_felt">
						...
						<p class="p_event">Info: Glæd dig til vores kommende event hos Tier1MTG. Kom til hygge i trygge rammer, hvor du kan spille med andre og vinde fede præmier.
							<br>
							<br>Tilmelding starter den 5. august.
						</p>
					</div>
				</div>
				<div class="event_indhold">
					...
					<div class="event_anden_text_felt">
						...
						<p class="p_event">Info: Glæd dig til vores kommende event hos Tier1MTG. Kom til hygge i trygge rammer, hvor du kan spille med andre og vinde fede præmier.
							<br>
							<br>Tilmelding starter den 15. august.
						</p>
					</div>
				</div>
			</div>
